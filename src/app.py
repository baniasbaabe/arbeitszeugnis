    ...
    with st.spinner("Your Job Reference will be decoded. Hold on..."):
        ...
        for image in images:
            try:
                ...
                st.error("API Connection Error: Please check if your country is eligible for the API https://ai.google.dev/available_regions. Or Gemini Pro API isn't free anymore :)")
                st.stop()
